...
class GAT_NC(torch.nn.Module):
    def __init__(self, hidden_channels, embedding_size, num_classes, two_layers, heads=4):
        super().__init__()
...
def main():
    ...
    for seed in seed_list:
        ...
        n_hop = 10
        num_neighbors_LP = {key: [15, 10, 5] for key in train_data_LP.edge_types}
